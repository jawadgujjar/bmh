        ...
        <Row gutter={[16, 16]} justify="center">
            <Col xs={24} sm={12} md={8}  >
                <Card title="Digital Marketing" bordered={false}>
                    Our company delivers comprehensive digital marketing services to boost your online presence. From targeted advertising and social media management to content creation and analytics, we craft strategies that drive engagement, increase brand visibility, and generate leads. Let us help you connect with your audience and achieve your marketing goals.
                </Card>
            </Col>
            <Col xs={24} sm={12} md={8}  >
